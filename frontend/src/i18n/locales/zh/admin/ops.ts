export default {
    ops: {
      availability: {
        title: '调度监控',
        description: '集中查看 OpenAI 账号切换、异常冷却和请求反馈',
        scope: 'OpenAI · 全部分组',
        refresh: '刷新',
        autoRefresh: '每 60 秒自动刷新',
        updatedAt: '更新于 {time}',
        loading: '正在读取监控数据…',
        refreshFailed: '更新失败。已有数据保留，请稍后刷新。',
        traceFailed: '关联日志加载失败，请重试。',
        switches: '切换尝试',
        switchesHint: '已记录的换号动作；最终结果见请求明细',
        cooldowns: '冷却记录',
        cooldownsHint: '历史冷却事件，恢复后记录仍会保留',
        errors: '请求报错',
        errorsHint: '已记录的最终请求错误，含路由和客户端限制',
        ttft: '首 Token P95',
        ttftHint: '95% 的已有样本不超过此值 · 参考目标 5 秒',
        ttftNote: '首 Token 使用现有上游转发统计，可能含推理事件；换号前失败尝试的等待不包含在内，不能等同于客户看到正文的总等待时间。',
        recordsNote: '数据来自已保存的运维日志。采样、保留期限或记录延迟会影响完整性；未查到记录不代表从未发生。',
        eventsTitle: '账号切换与冷却',
        eventsHint: '按时间展示两类事件各自最新的 20 条',
        errorsTitle: '最近请求问题',
        errorsListHint: '当前时间范围内最新 20 条错误',
        emptyEvents: '当前时间范围内没有查到切换或冷却记录',
        emptyErrors: '当前时间范围内没有查到请求报错',
        time: '发生时间',
        event: '事件',
        account: '账号',
        model: '模型',
        ...
        switchEvent: '尝试换号',
        cooldownEvent: '异常冷却',
        cooldownDuration: '{seconds} 秒 · 连续故障 {streak} 次',
        upstreamStatus: '上游状态 {status}',
        requestTrace: '请求明细',
        requestId: '请求 ID',
        traceTitle: '请求关联日志',
        traceHint: '展示同一请求 ID 下最新 100 条日志，仅显示定位所需字段。',
        finalResponse: '最终 HTTP 响应',
        pendingResponse: '尚未查到最终响应记录',
        streamNote: 'HTTP 200 仅表示响应状态；流式响应是否完整，应结合错误详情和完成事件判断。',
        noTrace: '该事件未记录请求 ID，可按账号和时间定位',
        noTraceLogs: '没有查到关联日志',
        status: '状态',
        seconds: '{value} 秒',
        openOps: '完整运维监控',
        openErrors: '查看全部请求记录',
        windowNote: '统计窗口：{start} 至 {end}'
      },
      title: '运维监控',
      description: '运维监控与排障',
      // Dashboard
