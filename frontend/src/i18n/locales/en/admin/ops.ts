export default {
    ops: {
      availability: {
        ...
        description: 'OpenAI account switches, cooldown events and request outcomes',
        scope: 'OpenAI · All groups',
        refresh: 'Refresh',
        autoRefresh: 'Refresh every 60 seconds',
        updatedAt: 'Updated at {time}',
        loading: 'Loading monitoring data…',
        refreshFailed: 'Refresh failed. Previous data is retained; please try again.',
        traceFailed: 'Could not load related logs. Please retry.',
        switches: 'Switch attempts',
        switchesHint: 'Recorded switch actions; inspect request details for the outcome',
        cooldowns: 'Cooldown events',
        cooldownsHint: 'Historical events remain after an account recovers',
        errors: 'Request errors',
        errorsHint: 'Recorded final request errors, including routing and client limits',
        ttft: 'First token P95',
        ttftHint: '95% of recorded samples are at or below this value · Target: 5 seconds',
        ttftNote: 'First-token metrics cover the upstream forwarding attempt and may include reasoning events. Waiting on earlier failed accounts is excluded; this is not the total client wait for visible text.',
        recordsNote: 'Data comes from stored Ops logs. Sampling, retention and ingestion delays affect completeness; no records does not prove no events occurred.',
        eventsTitle: 'Account switches and cooldowns',
        eventsHint: 'The latest 20 records of each event type, ordered by time',
        errorsTitle: 'Recent request issues',
        errorsListHint: 'The latest 20 errors in the selected window',
        emptyEvents: 'No switch or cooldown records found in this window',
        emptyErrors: 'No request error records found in this window',
        time: 'Time',
        event: 'Event',
        account: 'Account',
        model: 'Model',
        detail: 'Details',
        switchEvent: 'Switch attempted',
        cooldownEvent: 'Cooldown recorded',
        cooldownDuration: '{seconds}s · Failure streak: {streak}',
        upstreamStatus: 'Upstream status {status}',
        requestTrace: 'Request details',
        requestId: 'Request ID',
        traceTitle: 'Related request logs',
        traceHint: 'The latest 100 logs for the same request ID, with diagnostic fields only.',
        finalResponse: 'Final HTTP response',
        pendingResponse: 'No final response record found yet',
        streamNote: 'HTTP 200 is a response status. Check error details and terminal events to establish whether a stream completed.',
        noTrace: 'No request ID was recorded; use the account and time to investigate',
        noTraceLogs: 'No related logs found',
        status: 'Status',
        seconds: '{value}s',
        openOps: 'Full Ops dashboard',
        openErrors: 'All request records',
        windowNote: 'Window: {start} to {end}'
      },
